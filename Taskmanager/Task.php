...
<body>
    ...
    <?php if ($_SESSION['user']['status'] == 9) { ?>
                    ...
                    <? if ($products[3] != 1) { ?>
                        ...
                        <div class="accordion__body">
                            <form action="../action/statusTask.php?id=<?= $products[0] ?>" method="post" name="form">
                                ...
                                <a title="Профиль автора" href="/action/profile2.php" target="_blank"> <font class="owner"> <? echo $products[4]; ?> </font></a>
                            </form>
        ...
        <? } else {?>
            <script>
         result = prompt("У тебя нет прав на просмотр этой страницы. Извинись и иди Дальше", ["Извини"]);
         </script>
  <?php  
